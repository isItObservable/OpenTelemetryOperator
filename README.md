...
Let's deploy the vanila version of the hipster-shop ( no instrumentation library deployed in the docker image, except for the services built in GO and C#)
...
<p align="center">
<img src="image/image/traces_instrumentation.PNG" width="60%" alt="Dynatrace distributed traces" />
</p>

2. with the instrumentation applied by the operator
<p align="center">
<img src="image/traces_instrumentation_operator.PNG" width="60%" alt="Dynatrace distributed traces" />
</p>
